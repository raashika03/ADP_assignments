...
<?php
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        $mail->addAddress('rashikasinha32@gmail.com');
        $mail->Subject = 'group 12 assignment 2';
        ...
        $mail->Username = "nobisuzu456@gmail.com";

        //Set the password of your gmail address here
        $mail->Password = 'rashmika123';
        if(!$mail->send()) {
...
<body>
    <form action="<?php $_SERVER["PHP_SELF"]?>" method="POST">
        <div class="input-form">
            ...
            <input name="firstname" type="text" placeholder="Rashika" required>
        </div>
        <div class="input-form">
            <label for="lastname">Last Name*</label>
            <input name="lastname" type="text" placeholder="Rathi" required>
        </div>
        <div class="input-form">
            <label for="email">Email Address*</label>
            <input name="email" type="email" placeholder="rashikasinha32@gmail.com" required>
        </div>
        <div class="input-form">
            <label for="telephone-number">Telephone Number</label>
            <input name="telephone-number" type="number" placeholder="9113322022" required>
        </div>
        <div class="input-form">
            <label for="msg">Comments*</label>
            <textarea name="msg" cols="102" rows="10" required>Hi,

My group number is 12.
